          ...
          <div className="space-y-6">
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                {mounted && (
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 border-b border-gray-100 dark:border-gray-800 gap-4">
                    <div>
                    ...
                    <div className="flex bg-gray-100 dark:bg-gray-800 rounded-xl p-1 w-full sm:w-auto">
                      {['light', 'dark', 'system'].map((t) => (
                        <button
                          key={t}
                          onClick={() => setTheme(t)}
                          className={`flex-1 sm:px-6 py-2 rounded-lg text-sm font-bold capitalize transition-colors ${
                            theme === t
